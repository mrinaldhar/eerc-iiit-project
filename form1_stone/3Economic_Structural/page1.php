...
<form action= "form-1-backend.php" method="">
    ...
    <input type="radio" name="_2-1" value='a'/>Soft soil<br/>
    ...
    <input type="checkbox" name="_2-2[]" value='a'/>Strip foundation on non-uniform base<br/>
    <input type="checkbox" name="_2-2[]" value='b'/>Strip foundation with no through stones<br/>
    <input type="checkbox" name="_2-2[]" value='c'/>Strip foundation on soft soil<br/>
    <input type="checkbox" name="_2-2[]" value='d'/>Discontinuous RC foundation beam system<br/>
