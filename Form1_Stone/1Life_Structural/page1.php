...
<form action="form-1-backend.php" method="">
    ...
    <input type="checkbox" name="_2a" value='Y'/>Yes
    <input type="checkbox" name="_2a" value='N'/>No
    ...
    <input type="checkbox" name="_2b" value='Y'/>Yes
    <input type="checkbox" name="_2b" value='N'/>No
    <br/>
