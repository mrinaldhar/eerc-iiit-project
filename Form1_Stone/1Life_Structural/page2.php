...
<form action="form-1-backend.php" method="">
    ...
    <input type="checkbox" name="_3a" value='Y'/>Yes
    <input type="checkbox" name="_3a" value='N'/>No

    <p>b. The house has large una nchored projections and overhangs</p>
    <input type="checkbox" name="_3b" value='Y'/>Yes
    <input type="checkbox" name="_3b" value='N'/>No

    <p>c. Door and window openings in walls are at the corners</p>
    <input type="checkbox" name="_3c" value='Y'/>Yes
    <input type="checkbox" name="_3c" value='N'/>No

    <p>d. The house is touching or located too close to the adjacent seemingly unsafe house/construction</p>
    <input type="checkbox" name="_3d" value='Y'/>Yes
    <input type="checkbox" name="_3d" value='N'/>No
    <br/><br/>
    ...
    <input type="checkbox" name="_4b" value='Y'/>Yes
    <input type="checkbox" name="_4b" value='N'/>No

    <p>c. The walls are not integrated into each other at the corners</p>
    <input type="checkbox" name="_4c" value='Y'/>Yes
    <input type="checkbox" name="_4c" value='N'/>No
    <br/><br/>
    ...
    <input type="checkbox" name="_5a" value='Y'/>Yes
    <input type="checkbox" name="_5a" value='N'/>No
    <br/><br/>
