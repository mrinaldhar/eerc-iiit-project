...
<input type="checkbox" name="_4-2[]" value="e" id='_4-2_e_-5'> Large cut outs in diaphragm

<p>4.3 Foundation-wall connection</p>
<p>You may select 0 or more.</p>
<input type="checkbox" name="_4-3[]" value="a" id='_4-3_a_-5'> No anchorage of wall reinforcement to foundation

<p>4.4 Wall-wall connection</p>
<p>You may select 0 or more.</p>
<input type="checkbox" name="_4-4_1" value="a" id='_4-4_a_-5'> No roof band with pitched roof
<input type="checkbox" name="_4-4_1" value="b" id='_4-4_b_-5'> No roof band with flat roof
<input type="checkbox" name="_4-4_2[]" value="c" id='_4-4_c_-5'> No lintel band
<input type="checkbox" name="_4-4_2[]" value="d" id='_4-4_d_-5'> No sill band
<input type="checkbox" name="_4-4_2[]" value="e" id='_4-4_e_-5'> No plinth band
<input type="checkbox" name="_4-4_2[]" value="f" id='_4-4_f_-5'> Arches/vaults without tie rods
...
<input type="radio" name="_4-6" value="c" id='_4-6_c_-5' checked> None of the Above

<p>4.7 Large water tanks on roof</p>
<input type="radio" name="_4-7" value="a" id='_4-7_a_-5'> Unsymmetrically located and integrally built staircase
<input type="radio" name="_4-7" value="b" id='_4-7_b_-5'> Staircase not adequately separated from the house
<input type="radio" name="_4-7" value="c" id='_4-7_c_-5' checked> None of the Above
